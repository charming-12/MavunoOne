...
export default function BossError({ error, reset }: ErrorProps) {
  useEffect(() => {
    // Log error details for debugging
    console.error("🚨 Boss Section Error:", {
      section: "boss",
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-8 text-center">
        ...
        {/* Error Message */}
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Hitilafu kwenye Sehemu ya Boss</h1>
        <p className="text-gray-600 mb-4">
          Karibu, hitilafu imetokea. Tafadhali jaribu tena au rudi nyuma.
        </p>
