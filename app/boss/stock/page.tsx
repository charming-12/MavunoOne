    ...
    <main className="min-h-screen bg-[#f7f9f8] p-4 text-slate-900 sm:p-6 lg:p-10">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div><p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-700">Executive inventory</p><h1 className="mt-1 text-3xl font-black">Stock — hali halisi</h1><p className="mt-2 text-sm text-slate-500">Muhtasari wa bidhaa na threshold kutoka database ya MavunoOne.</p></div>
