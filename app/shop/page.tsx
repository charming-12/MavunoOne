...
const productImages: Array<{ keywords: string[]; src: string; alt: string }> = [
  ...
  { keywords: ["animal feed", "animal feeds", "animal food", "feeds", "feed", "uduv", "chakula cha mifugo", "chakula cha wanyama", "chakula cha kuku", "chakula cha ng'ombe", "mifugo", "soya", "soy", "soybean", "soyabean", "soya cake", "mashudu", "pumba", "bran", "cake", "by-product", "byproduct", "chokka", "choka", "udaga"], src: "/products/animal-feeds.jpg", alt: "Animal feeds, soya na mashudu kwa mifugo" },
