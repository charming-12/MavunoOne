...
const sidebarItems: SidebarItem[] = [
  { href: "/office", label: "Dashboard", icon: LayoutDashboard, group: "Main", roles: ["admin", "owner", "manager", "cashier", "storekeeper", "machine_operator"] },
  ...
  { href: "/office/vehicles", label: "Magari", icon: Truck, group: "Operations", roles: ["admin", "owner", "manager"] },
  { href: "/office/cameras", label: "Kamera", icon: Camera, group: "Security", roles: ["admin", "owner", "manager"] },
  { href: "/office/deliveries", label: "Uwasilishaji", icon: Truck, group: "Operations", roles: ["admin", "owner", "manager"] },
  ...
  { href: "/office/reports", label: "Ripoti", icon: FileBarChart, group: "Reports", roles: ["admin", "owner", "manager"] },
  { href: "/office/advanced-analytics", label: "Uchambuzi Mkali", icon: BarChart3, group: "Reports", roles: ["admin", "owner", "manager"] },
  ...
  { href: "/office/notifications", label: "Arifa", icon: Bell, group: "System", roles: ["admin", "owner", "manager", "cashier", "storekeeper", "machine_operator"] },
