...
const sidebarItems: SidebarItem[] = [
  ...
  { href: "/office/products", label: "Products", icon: Package, group: "Inventory", roles: ["admin", "manager"] },
...
export default function OfficeLayout({ children }: { children: React.ReactNode }) {
  ...
  const portalLabel = isFinanceManager ? "Finance Manager" : roleLabels[role || ""] || "Operations User";
