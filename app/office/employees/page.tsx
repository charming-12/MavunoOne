...
export default function EmployeesPage() {
  ...
  const removeSeededMockAccounts = async () => {
    ...
    try {
      ...
      setMessage(data.message); void loadUsers();
  ...
  const createInvitation = async (event: React.FormEvent) => {
    ...
    setSetupUrl(data.setupUrl); setMessage(data.emailSent ? "Account imeundwa na invitation imetumwa kwenye email ya staff. Staff ataweka password yake mwenyewe." : "Account imeundwa, lakini email haikutumwa. Tumia link ya setup kwa njia salama."); setForm({ name: "", email: "", phone: "", jobTitle: "cashier", role: "cashier" }); void loadUsers();
  };
