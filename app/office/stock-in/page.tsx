...
const blankForm: FormState = {
  productId: "", quantity: "", entryUnit: "kg", supplierName: "", supplierPhone: "", sourceType: "supplier", purchaseReference: "", batchNumber: "", vehicleReference: "", warehouseLocation: "", receivedBy: "", qualityStatus: "accepted", costPerUnit: "", notes: "",
};
...
export default function StockInPage() {
  ...
  const submit = (event: FormEvent) => {
    ...
    createStockIn.mutate({
      productId: Number(form.productId), quantity: Number(form.quantity), entryUnit: form.entryUnit, supplierName: form.supplierName || undefined, supplierPhone: form.supplierPhone || undefined, sourceType: form.sourceType, purchaseReference: form.purchaseReference || undefined, batchNumber: form.batchNumber || undefined, vehicleReference: form.vehicleReference || undefined, warehouseLocation: form.warehouseLocation || undefined, receivedBy: form.receivedBy || undefined, qualityStatus: form.qualityStatus, costPerUnit: Number(form.costPerUnit || 0), notes: form.notes || undefined,
    });
  };
