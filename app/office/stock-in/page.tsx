...
const units = ["kg", "debe", "gunia", "unit"] as const;
...
export default function StockInPage() {
  ...
  const totals = useMemo(() => ({
    kg: records.reduce((sum, record) => sum + Number(record.baseQuantity ?? 0), 0),
