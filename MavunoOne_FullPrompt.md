# MAVUNOONE — FULL PROMPT + FILE STRUCTURE
...
PORTALS:
1. Office Portal (desktop) — sidebar navigation
2. Boss Portal (mobile-first PWA) — bottom navigation
3. Customer Portal (simplified) — bei, oda, deni
...
│   │   │   ├── page.tsx ← Dashboard
│   │   │   ├── pos/page.tsx ← POS
│   │   │   ├── sales/page.tsx ← Mauzo
│   │   │   ├── products/page.tsx ← Bidhaa
│   │   │   ├── stock-in/page.tsx ← Stock In
│   │   │   ├── stock-out/page.tsx ← Stock Out
│   │   │   ├── customers/page.tsx ← Wateja
│   │   │   ├── machines/page.tsx ← Mashine
│   │   │   ├── deliveries/page.tsx ← Oda za kupeleka
│   │   │   ├── vehicles/page.tsx ← Magari + GPS
│   │   │   ├── expenses/page.tsx ← Gharama
│   │   │   ├── closures/page.tsx ← Funguo za siku
│   │   │   ├── reports/page.tsx ← Ripoti
│   │   │   └── settings/page.tsx ← Settings
│   │   ├── boss/
│   │   │   ├── layout.tsx ← Bottom nav layout
│   │   │   ├── page.tsx ← Dashboard
│   │   │   ├── sales/page.tsx ← Mauzo overview
│   │   │   ├── stock/page.tsx ← Stock overview
│   │   │   ├── machines/page.tsx ← Mashine overview
│   │   │   ├── vehicles/page.tsx ← GPS map
│   │   │   └── notifications/page.tsx ← Arifa
│   │   └── shop/
│   │       ├── page.tsx ← Bei za bidhaa
│   │       ├── order/page.tsx ← Kuweka oda
│   │       └── account/page.tsx ← Deni na history
│   ├── components/
...
**Contact:** Josia Makungu Marco — 0626522599 — josiahmarco93@gmail.com
